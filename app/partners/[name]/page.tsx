...
//     const { name } = await params;  // ✅ must await in Next.js 15
...
//                 <Image
//                   src={partnerData?.logo ?? "/partners/placeholder-logo.png"}
...
//         {/* Stats Cards */}
//         <div className="grid grid-cols-1 md:grid-rows-1 md:grid-cols-3 gap-6 mb-8">
